 ...
 * @version Oct 30, 2012
 */
public class MyAcountPresenter
    ...
    public interface MyView
            extends View, HasUiHandlers<MyAcountUiHandlers> {
     ...
     */
    @ProxyCodeSplit
    @NameToken(NameTokens.ADMIN_MENU_BUTTONS.MY_ACOUNT)
    public interface MyProxy
            extends ProxyPlace<MyAcountPresenter> {

    }

    /**
     * Instantiates a new my acount presenter.
     * 
     * @param eventBus
     *        the event bus
     * @param view
     ...
     */
    @Inject
    public MyAcountPresenter(EventBus eventBus,
                             MyView view,
                             MyProxy proxy,
    ...
    protected void onReset() {
        ...
        getEventBus().fireEvent(new MenuButtonClickedEvent(ADMIN_MENU_BUTTONS.MY_ACOUNT, false));
    }
