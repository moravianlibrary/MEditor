...
public class FedoraAPIAService
    ...
    public FedoraAPIAService() {
        super(FEDORAAPIASERVICE_WSDL_LOCATION, new QName("http://www.fedora.info/definitions/1/0/api/",
     ...
     * 
     * @return the fedora apia service http port returns FedoraAPIA
     */
    ...
    public FedoraAPIA getFedoraAPIAServiceHTTPPort() {
        return super.getPort(new QName("http://www.fedora.info/definitions/1/0/api/",
                                       "Fedora-API-A-Service-HTTP-Port"), FedoraAPIA.class);
    }
    ...
    public FedoraAPIA getFedoraAPIAServiceHTTPPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.fedora.info/definitions/1/0/api/",
                                       "Fedora-API-A-Service-HTTP-Port"), FedoraAPIA.class, features);
    }
