...
public class NameHolder
    ...
    public NameHolder() {
        ...
        this.roles =
                new ListOfListOfSimpleValuesHolder(ModsConstants.ROLE,
                                                   ModsConstants.TYPE,
    ...
    public NameTypeClient getName() {
        ...
        if (getAttributeForm() != null) {
            ...
            nameTypeClient.setType(NameTypeAttributeClient.fromValue(getAttributeForm()
            ...
            nameTypeClient.setTransliteration(getAttributeForm()
