...
import cz.mzk.editor.client.metadata.ListOfListOfSimpleValuesHolder;
...
import cz.mzk.editor.client.metadata.RelatedItemHolder;
...
import cz.mzk.editor.client.view.other.TabUtils.GetLayoutOperation;
...
public class ModsTab
    ...
    private class GetRelatedItem
         ...
         * (non-Javadoc)
         * @see
         * cz.mzk.editor.client.view.other.TabUtils.GetLayoutOperation
         * #execute()
         */
     ...
     * (non-Javadoc)
     * @see
     * cz.mzk.editor.client.metadata.RelatedItemHolder#getMods()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see cz.mzk.editor.client.metadata.RelatedItemHolder#
