...
import cz.mzk.editor.client.view.ModifyView.MyUiHandlers;
...
public class ModifyPresenter
     ...
     * (non-Javadoc)
     * @see
     * cz.mzk.editor.client.view.ModifyView.MyUiHandlers#getDescription
     ...
     * (non-Javadoc)
     * @see
     * cz.mzk.editor.client.view.ModifyView.MyUiHandlers#putDescription
     ...
     * (non-Javadoc)
     * @see
     * cz.mzk.editor.client.view.ModifyView.MyUiHandlers#onRefresh
     * (java.lang.String)
     */
    @Override
