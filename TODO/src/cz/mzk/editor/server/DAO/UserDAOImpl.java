...
import cz.mzk.editor.server.exception.DatabaseException;
...
public class UserDAOImpl
     ...
     * (non-Javadoc)
     * @see
     * cz.mzk.editor.server.DAO.UserDAO#isSupported(java.lang.String
     * )
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * cz.mzk.editor.server.DAO.UserDAO#addUser(cz.fi.muni.xkremser
     ...
     * (non-Javadoc)
     * @see
     * cz.mzk.editor.server.DAO.UserDAO#getIdentities(java.lang
     * .String )
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * cz.mzk.editor.server.DAO.UserDAO#addUserIdentity(cz.fi.muni
     ...
     * (non-Javadoc)
     * @see
     * cz.mzk.editor.server.DAO.UserDAO#removeUserIdentity(long)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * cz.mzk.editor.server.DAO.UserDAO#addUserRole(cz.fi.muni.
     * xkremser .editor.shared.rpc.RoleItem, long)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * cz.mzk.editor.server.DAO.UserDAO#hasRole(java.lang.String,
     * long)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * cz.mzk.editor.server.DAO.UserDAO#getName(java.lang.String)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * cz.mzk.editor.server.DAO.UserDAO#openIDhasRole(java.lang
