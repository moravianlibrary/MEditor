...
public class CreatePresenter
        extends Presenter<CreatePresenter.MyView, CreatePresenter.MyProxy>
    ...
    public interface MyProxy
            extends ProxyPlace<CreatePresenter> {
     ...
     */
    @Inject
    public CreatePresenter(final EventBus eventBus,
                           final MyView view,
                           final MyProxy proxy,
        ...
        items[0].addClickHandler(new com.smartgwt.client.widgets.menu.events.ClickHandler() {
            ...
            public void onClick(MenuItemClickEvent event) {
                ...
                placeManager.revealRelativePlace(new PlaceRequest(NameTokens.MODIFY)
                        .with(Constants.URL_PARAM_CODE, uuidToEdit));
            }
        });
                    ...
                    public void callback(GetDigitalObjectDetailResult result) {
                        ...
                        String title =
                                detail.getDc().getTitle() == null ? "no title" : detail.getDc().getTitle()
                                        .get(0);
                        DigitalObjectOpenedEvent.fire(CreatePresenter.this,
                                                      true,
