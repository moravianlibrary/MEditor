...
public class ModsTab extends Tab {
	...
	private TabSet getModsTabSet() {
		...
		Tab[] tabs = new Tab[] { getTab(TabUtils.getTitleInfoStack(true), "Title Info"), getTab(TabUtils.getTypeOfResourceStack(true), "Type"),
				getTab(TabUtils.getGenreStack(true), "Genre"), getTab(TabUtils.getOriginInfoStack(true), "Origin"),
				...
				deep > 0 ? new ModsTab(deep - 1, false) : MAX_DEEP, getTab(TabUtils.getIdentifierStack(true), "Identifier"),
