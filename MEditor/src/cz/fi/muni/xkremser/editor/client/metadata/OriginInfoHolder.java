...
public class OriginInfoHolder
    ...
    public OriginInfoHolder() {
        ...
        this.frequencies =
                new ListOfListOfSimpleValuesHolder(ModsConstants.FREQUENCY, ModsConstants.AUTHORITY);
    ...
    public OriginInfoTypeClient getOriginInfo() {
        ...
        if (getAttributeForm() != null) {
            ...
            originInfoTypeClient.setTransliteration(getAttributeForm()
