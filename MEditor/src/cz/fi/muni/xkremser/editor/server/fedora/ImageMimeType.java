...
public enum ImageMimeType {
	...
	JPEG("image/jpeg", "jpg", true, false), PNG("image/png", "png", true, false), JPEG2000("image/jp2", "jp2", true, false),

	XDJVU("image/x.djvu", "djvu", false, true), VNDDJVU("image/vnd.djvu", "djvu", false, true), DJVU("image/djvu", "djvu", false, true), PDF("application/pdf",
			"pdf", false, true);
