 ...
 */
public class DigitalObjectHandlerImpl implements DigitalObjectHandler {
	...
	@Override
	public DigitalObjectDetail getDigitalObjectItems(String uuid, DigitalObjectModel childModel) throws IOException {
