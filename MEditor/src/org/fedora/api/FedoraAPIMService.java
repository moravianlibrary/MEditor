...
public class FedoraAPIMService
    ...
    /** The Constant FEDORAAPIMSERVICE_WSDL_LOCATION. */
    ...
    /**
     * Instantiates a new fedora apim service.
     * 
     * @param wsdlLocation
     *        the wsdl location
     * @param serviceName
    ...
    public FedoraAPIMService() {
        super(FEDORAAPIMSERVICE_WSDL_LOCATION, new QName("http://www.fedora.info/definitions/1/0/api/",
                                                         "Fedora-API-M-Service"));
    }

    /**
     * Gets the fedora apim service http port.
     * 
     * @return the fedora apim service http port returns FedoraAPIM
     */
    @WebEndpoint(name = "Fedora-API-M-Service-HTTP-Port")
    public FedoraAPIM getFedoraAPIMServiceHTTPPort() {
        return super.getPort(new QName("http://www.fedora.info/definitions/1/0/api/",
                                       "Fedora-API-M-Service-HTTP-Port"), FedoraAPIM.class);
    }
    ...
    public FedoraAPIM getFedoraAPIMServiceHTTPPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.fedora.info/definitions/1/0/api/",
                                       "Fedora-API-M-Service-HTTP-Port"), FedoraAPIM.class, features);
    }
