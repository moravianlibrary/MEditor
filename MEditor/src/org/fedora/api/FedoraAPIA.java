...
public interface FedoraAPIA {
     ...
     * Describe repository.
     * 
     * @return the repository info returns org.fedora.api.RepositoryInfo
     */
     ...
     * @param asOfDateTime
     *        the as of date time
     * @return the object profile returns org.fedora.api.ObjectProfile
     */
     ...
     * @param asOfDateTime
     *        the as of date time
     * @return the list returns java.util.List<org.fedora.api.ObjectMethodsDef>
     */
    ...
    public List<ObjectMethodsDef> listMethods(@WebParam(name = "pid", targetNamespace = "") String pid,
                                              @WebParam(name = "asOfDateTime", targetNamespace = "") String asOfDateTime);
     ...
     * @param asOfDateTime
     *        the as of date time
     * @return the list returns java.util.List<org.fedora.api.DatastreamDef>
     */
    ...
    public List<DatastreamDef> listDatastreams(@WebParam(name = "pid", targetNamespace = "") String pid,
                                               @WebParam(name = "asOfDateTime", targetNamespace = "") String asOfDateTime);
     ...
     * @param asOfDateTime
     *        the as of date time
     * @return the datastream dissemination returns
     *         org.fedora.api.MIMETypedStream
     */
    ...
    public MIMETypedStream getDatastreamDissemination(@WebParam(name = "pid", targetNamespace = "") String pid,
     ...
     * @param asOfDateTime
     *        the as of date time
     * @return the dissemination returns org.fedora.api.MIMETypedStream
     */
    ...
    public MIMETypedStream getDissemination(@WebParam(name = "pid", targetNamespace = "") String pid,
                                            @WebParam(name = "serviceDefinitionPid", targetNamespace = "") String serviceDefinitionPid,
                                            @WebParam(name = "methodName", targetNamespace = "") String methodName,
                                            @WebParam(name = "parameters", targetNamespace = "") org.fedora.api.GetDissemination.Parameters parameters,
                                            @WebParam(name = "asOfDateTime", targetNamespace = "") String asOfDateTime);
     ...
     * @param query
     *        the query
     * @return the field search result returns org.fedora.api.FieldSearchResult
     */
    ...
    public FieldSearchResult findObjects(@WebParam(name = "resultFields", targetNamespace = "") ArrayOfString resultFields,
                                         @WebParam(name = "maxResults", targetNamespace = "") BigInteger maxResults,
                                         @WebParam(name = "query", targetNamespace = "") FieldSearchQuery query);
    ...
    public FieldSearchResult resumeFindObjects(@WebParam(name = "sessionToken", targetNamespace = "") String sessionToken);
     ...
     * @param pid
     *        the pid
     * @return the object history returns java.util.List<java.lang.String>
     */
    ...
    public List<String> getObjectHistory(@WebParam(name = "pid", targetNamespace = "") String pid);
