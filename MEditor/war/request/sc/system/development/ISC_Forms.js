...
this.setValue(this.defaultValue)}
,isc.A.valueFieldChanged=function isc_RelativeDateItem_valueFieldChanged(_1,_2){this.fieldChanged();if(!_2&&this.quantityField.isVisible())this.quantityField.delayCall("focusInItem")}
...
if(isc.isA.Date(_1)||this.valueField.valueMap[_1]){this.valueField.setValue(isc.isA.Date(_1)?this.formatDate(_1):_1);this.valueFieldChanged(_1,true);return}
...
,isc.A.setValue=function isc_DateRangeItem_setValue(_1){var _2=_1?_1.start:null,_3=_1?_1.end:null;this.setFromDate(_2);this.setToDate(_3)}
