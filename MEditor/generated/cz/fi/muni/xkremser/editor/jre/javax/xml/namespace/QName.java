 ...
 * Schema Part2: Datatypes specification</a>, <a
 * href="http://www.w3.org/TR/REC-xml-names/#ns-qualnames">Namespaces in
...
public class QName implements Serializable {
	 ...
	 * value represents no explicitly defined Namespace as defined by the <a
	 * href="http://www.w3.org/TR/REC-xml-names/#ns-qualnames">Namespaces in
	 * XML</a> specification. This action preserves compatible behavior with QName
	 * 1.0. Explicitly providing the {@link javax.xml.XMLConstants#NULL_NS_URI
	 ...
	 * 
	 * <p>
	 * The Namespace URI is not validated as a <a
	 * href="http://www.ietf.org/rfc/rfc2396.txt">URI reference</a>. The local
	 * part is not validated as a <a
	 * href="http://www.w3.org/TR/REC-xml-names/#NT-NCName">NCName</a> as
	...
	/**
	 * <p>
	 * <code>QName</code> constructor specifying the Namespace URI, local part and
	 * prefix.
	 * </p>
	 * 
	 * <p>
	 ...
	 * The Namespace URI is not validated as a <a
	 * href="http://www.ietf.org/rfc/rfc2396.txt">URI reference</a>. The local
	 * part and prefix are not validated as a <a
	 * href="http://www.w3.org/TR/REC-xml-names/#NT-NCName">NCName</a> as
	 * specified in <a href="http://www.w3.org/TR/REC-xml-names/">Namespaces in
	 * XML</a>.
	 * </p>
	 ...
	 * {@link javax.xml.XMLConstants#NULL_NS_URI XMLConstants.NULL_NS_URI} and the
	 * prefix is set to {@link javax.xml.XMLConstants#DEFAULT_NS_PREFIX
	 * XMLConstants.DEFAULT_NS_PREFIX}.
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * The local part is not validated as a <a
	 * href="http://www.w3.org/TR/REC-xml-names/#NT-NCName">NCName</a> as
	 * specified in <a href="http://www.w3.org/TR/REC-xml-names/">Namespaces in
	 * XML</a>.
	 * </p>
	 ...
	 * 
	 * <p>
	 * The prefix assigned to a <code>QName</code> might <strong><em>NOT</em>
	 * </strong> be valid in a different context. For example, a
	 ...
	 *         <code>QName</code> else <code>false</code>
	 */
	@Override
	 ...
	 * 
	 * <p>
	 * The hash code is calculated using both the Namespace URI and the local part
	 * of the <code>QName</code>. The prefix is <strong><em>NOT</em></strong> used
	 ...
	 * <code>String</code> was <a
	 * href="http://jclark.com/xml/xmlns.htm">defined</a> by James Clark. Although
	 * this is not a <em>standard</em> specification, it is in common use, e.g.
	 ...
	 * returned. An appropriate use of this method is for debugging or logging for
	 * human consumption.
	 * </p>
	 * 
	 * <p>
	 * Note the prefix value is <strong><em>NOT</em></strong> returned as part of
	 ...
	 * 
	 * <p>
	 * <em>The <code>String</code> <strong>MUST</strong> be in the
	 * form returned by {@link #toString() QName.toString()}.</em>
	 * </p>
	 * 
	 * <p>
	 * The commonly accepted way of representing a <code>QName</code> as a
	 ...
	 * <code>.equals(XMLConstants.NULL_NS_URI)</code>, only the local part should
	 * be provided.
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * <p>
	 * This method does not do full validation of the resulting <code>QName</code>.
	 * <p>
	 * The Namespace URI is not validated as a <a
	 * href="http://www.ietf.org/rfc/rfc2396.txt">URI reference</a>. The local
	 * part is not validated as a <a
	 ...
	 * 
	 * @throws IllegalArgumentException
	 *           When <code>qNameAsString</code> is <code>null</code> or malformed
	 * 
	...
	public static QName valueOf(String qNameAsString) {
		...
		if (qNameAsString.startsWith("{" + XMLConstants.NULL_NS_URI + "}")) {
			throw new IllegalArgumentException("Namespace URI .equals(XMLConstants.NULL_NS_URI), " + ".equals(\"" + XMLConstants.NULL_NS_URI + "\"), "
					+ "only the local part, " + "\"" + qNameAsString.substring(2 + XMLConstants.NULL_NS_URI.length()) + "\", " + "should be provided.");
		}
