...
public class UserDAOImpl
     ...
     * (non-Javadoc)
     * @see
     * cz.fi.muni.xkremser.editor.server.DAO.UserDAO#getIdentities(java.lang
     * .String )
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * cz.fi.muni.xkremser.editor.server.DAO.UserDAO#removeUserIdentity(long)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * cz.fi.muni.xkremser.editor.server.DAO.UserDAO#addUserRole(cz.fi.muni.
     ...
     * (non-Javadoc)
     * @see
     * cz.fi.muni.xkremser.editor.server.DAO.UserDAO#openIDhasRole(java.lang
