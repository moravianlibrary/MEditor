...
public class RecentlyModifiedItemDAOImpl
     ...
     * (non-Javadoc)
     * @see
     * cz.mzk.editor.server.DAO.RecentlyModifiedItemDAO#put(cz.fi
     ...
     * (non-Javadoc)
     * @see
     * cz.mzk.editor.server.DAO.RecentlyModifiedItemDAO#getItems
     * (int, boolean)
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * cz.mzk.editor.server.DAO.RecentlyModifiedItemDAO#putDescription
     ...
     * (non-Javadoc)
     * @see
     * cz.mzk.editor.server.DAO.RecentlyModifiedItemDAO#getDescription
     * (java.lang.String)
     */
    @Override
