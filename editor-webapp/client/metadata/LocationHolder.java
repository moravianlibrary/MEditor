...
public class LocationHolder
    ...
    public LocationHolder() {
        ...
        this.physicalLocations =
                new ListOfListOfSimpleValuesHolder(ModsConstants.PHYSICAL_LOCATION,
        ...
        this.urls =
                new ListOfListOfSimpleValuesHolder(ModsConstants.URL,
                                                   ModsConstants.DISPLAY_LABEL,
    ...
    public LocationTypeClient getLocation() {
        ...
        if (holdingSimples.size() > 0) {
            ...
            List<CopyInformationTypeClient> info =
                    new ArrayList<CopyInformationTypeClient>(holdingSimples.size());
    ...
    /*
     * (non-Javadoc)
     * @see cz.mzk.editor.client.metadata.MetadataHolder#getValue()
     */
    @Override
